    ...
    <div class="page-inner py-45">
      <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
        ...
        <div class="ml-md-auto py-2 py-md-0">
          ...
          <a href="?module=form_entri_satuan" class="btn btn-primary btn-round mr-2">
                ...
                <tr>
                  ...
                  <td width="70" class="text-center">
                    <div>
                      ...
                      <a href="?module=form_ubah_satuan&id=<?php echo $data['id_satuan']; ?>" class="btn btn-icon btn-round btn-primary btn-sm mr-md-1" data-toggle="tooltip" data-placement="top" title="Ubah">
